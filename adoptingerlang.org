...
We'll give you two principal approaches: starting by building around an expert, and otherwise creating your expertise in-house. We'll also tackle the topic of remote teams.
...
As this prototyping work is being done, your expert should start guiding your team towards broader and more complex concepts: developing for fault tolerance (how do you structure supervision trees properly?), eventually going for releases, and finally performance-related and production debugging concerns.

One of our favorite experiment to run is to have the expert guide the team into building their own supervision structure, ideally with the prototype the team has been working on:
...
5. Insert supervisors above the components that could be failing and assume that after each fault, each of the component starts from a predictable non-dynamic state (initial arguments passed by the supervisor)
...
- look into existing code out there, and do a show-and-tell of various libraries and their approaches; dig to figure out how they are structured.
