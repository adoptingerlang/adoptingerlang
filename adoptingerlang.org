...
restarted. The probe should only be used for cases the process does not crash
but for some reason has deadlocked and can not respond to requests. For this
