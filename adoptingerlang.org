...
In the beginning there was =systools=. During this time building releases was a manual process that user's built their own tooling around. Then came =reltool=, a release management tool that comes with Erlang/OTP and was meant to ease the creation of releases, it even has a gui!
