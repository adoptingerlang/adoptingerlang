...
<p>There were a number of issues with Helm aside from the templating that we won't get into here, except to say that they are being worked out in the next major release, <a href="https://v3.helm.sh/">Helm v3</a>. As of this writing in November 2019 has release candidates available. So I would still suggest taking a look at the latest offering from Helm.</p>
#+end_admonition
