...
To get a feel for what we will be doing in the next chapters copy =_build/prod/rel/service_discovery/service_discovery-0.1.0.tar.gz= to =/tmp/service_discovery= and unpack it:
