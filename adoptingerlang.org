...
Common Test HTML output is stored with Circle's artifacts feature which then serves them up over HTTP to view in your browser:

<screenshots of circleci->CT output flow>
